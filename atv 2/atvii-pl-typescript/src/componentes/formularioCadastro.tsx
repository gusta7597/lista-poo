...
interface FormularioCadastroState {
    selectedOption: string
}

export default class FormularioCadastro extends Component<props, FormularioCadastroState> {
    ...
    handleSelectOption = (event: ChangeEvent<HTMLInputElement>) => {
